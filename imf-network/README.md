...
...
*Data.IMF.Network> params = ServerParams { serverName = "mx1.dev.example.com", serverIP = "0.0.0.0", serverPort = "2525", serverMaxSessions = 10, serverMaxMsgSize = 10485760, serverMaxRcpts = 100, serverAuthReq = False }
*Data.IMF.Network> hooks = Hooks { hookLogSession = \(session, log) -> do print session; printLog log, hookVerifyReturnPath = \_ -> return (), hookVerifyRcpt = \_ -> return (), hookSaveMessage = \buffer _ -> do print buffer, hookAuthenticate = \_ _ -> return () }
...
Session {sessionConnection = "closed", sessionError = OK, sessionCreatedAt = 2019-12-02 05:01:13.407413491 UTC, sessionClientName = "mail11.static.mailgun.info", sessionInitialized = True, sessionAuthenticated = False, sessionBuffer = Nothing}
